...
parser = ArgumentParser(
    description="Run objective-3 shared-context LLM experiments across models and warehouse scenarios",
...
parser.add_argument("--results_dir", type=str, default="results/obj3_shared_context_llm_experiments", help="Directory for logs and summaries")
