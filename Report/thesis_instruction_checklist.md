...
#### What make a research? (Optional)
_A thesis does not need to satisfy every criterion fully, but these points help evaluate its scientific quality._
- [✓] The thesis introduces original ideas, methods, models, or insights that go beyond existing work. It does not merely apply known techniques in a routine manner, but advances the current state of knowledge.
- [✓] All methods, derivations, implementations, and conclusions are logically sound and technically accurate. Claims are supported by valid reasoning, appropriate analysis, or experimental evidence.
- [✓] The findings and methods are applicable beyond a single specific instance or case study. The results demonstrate relevance to a broader class of problems, systems, or conditions.
- [✓] The thesis provides sufficient methodological detail, including assumptions, algorithms, experimental setup, and parameters, to allow others to independently reproduce the results and verify the conclusions.
- [✓] The work is conducted with scientific rigor, including formal theoretical analysis, well-designed experiments, or both. Evaluation methods are appropriate, systematic, and clearly justified.
- [✓] The thesis makes a meaningful contribution by expanding knowledge, proposing new approaches, providing new evidence, or offering insights that are valuable to researchers and practitioners in the field.

---

### Writing
- [✓] My texts are original. I did not copy-paste from other sources.
- [n/a] My research questions and solutions are mathematically formulated.
...
- [x] I did not cite non-peer-reviewed sources (e.g., blog posts, Medium).
...
- [n/a] For all theoretical results, I stated the full set of assumptions, and the proofs are complete and correct.
...
### Others
- [n/a] I acknowledged funding agencies and infrastructures used (if applicable).
- [n/a] The authors' contributions are detailed if the thesis has multiple authors.
...
- [x] I used booktabs, microtype, and hyperlinks.
