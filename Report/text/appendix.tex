...
For example, parsing and invalid-action fields help identify whether poor delivery performance is associated with structured-output failures or invalid model actions.
