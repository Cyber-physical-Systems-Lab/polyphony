...
parser = ArgumentParser(
    description="Run objective-1 shared-context LLM experiments across models and warehouse scenarios",
...
parser.add_argument("--results_dir", type=str, default="results/obj1_shared_context_llm_experiments", help="Directory for logs and summaries")
