...
\begin{enumerate}
\item \textbf{RQ1 (Model Size):} How does language-model size affect collaborative task performance in a constrained warehouse environment?
...
\item \textbf{RQ3 (Prompt Representation):} How do natural-language and \gls{json}-based environment representations affect collaborative task performance?
\end{enumerate}
