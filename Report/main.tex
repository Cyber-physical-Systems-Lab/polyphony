...
\input{figures/charts/latex/report_charts.tex}
...
\subtitle{Exploring Model Choice, Planning Architecture, and Prompt Configuration}

% TODO: Request the assigned UPTEC serial number from the university before final submission.
...
\label{sec:ethics_sustainability}
\input{text/ethics_sustainability}
...
%   IEEEtran gives numbered references in citation order.
